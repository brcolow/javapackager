...
public class Resources extends DataType {
   private List<com.sun.openjfx.tools.ant.FileSet> rsets =
           new LinkedList<com.sun.openjfx.tools.ant.FileSet>();
    ...
    public List<com.sun.openjfx.tools.ant.FileSet> getResources() {
        return get().rsets;
    }

    public com.sun.openjfx.tools.ant.FileSet createFileSet() {
        com.sun.openjfx.tools.ant.FileSet r = new com.sun.openjfx.tools.ant.FileSet();
        rsets.add(r);
        return r;
    }
    ...
    private void getJars(String mode, List<String> lst) {
        for (com.sun.openjfx.tools.ant.FileSet r : getResources()) {
