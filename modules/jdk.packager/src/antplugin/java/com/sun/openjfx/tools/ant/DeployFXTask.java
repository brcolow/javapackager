...
package com.sun.openjfx.tools.ant;
...
import com.sun.openjfx.tools.ant.Platform.Jvmarg;
import com.sun.openjfx.tools.ant.Platform.Property;
import com.sun.openjfx.tools.packager.DeployParams;
import com.openjdk.tools.packager.Log;
import com.sun.openjfx.tools.packager.PackagerException;
import com.sun.openjfx.tools.packager.PackagerLib;
import com.sun.openjfx.tools.packager.bundlers.Bundler;
import com.sun.openjfx.tools.packager.bundlers.Bundler.Bundle;
...
public class DeployFXTask extends Task implements DynamicAttribute {
    ...
    public void execute() {
        ...
        if (versionCheck) {
            if (!com.sun.openjfx.tools.ant.VersionCheck.isSameVersion()) {
