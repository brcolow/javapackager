...
public class CLITest {
    ...
    public void simpleTest() throws Exception {
        ...
        Assume.assumeTrue(!System.getProperty("os.name").toLowerCase().contains("os x") ||
                Boolean.parseBoolean(System.getProperty("FULL_TEST")));
    ...
    public void userJvmArgNoValue() throws Exception {
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ...
            outStr.flush();
            oldOut.println(baos);
            Assert.assertTrue("Look for expected failure message", baos.toString().contains("Provide a value for " +
                    "the key or split the key into a key/value pair.  Such as '-Xmx1G' into '-Xmx' and '1G'."));
        } finally {
