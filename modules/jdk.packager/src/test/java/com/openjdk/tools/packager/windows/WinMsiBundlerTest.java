...
import com.openjdk.tools.packager.AbstractBundler;
...
import static com.openjdk.tools.packager.windows.WinAppBundler.ICON_ICO;
import static com.openjdk.tools.packager.windows.WinMsiBundler.PRODUCT_VERSION;
import static com.openjdk.tools.packager.windows.WindowsBundlerParam.WIN_RUNTIME;
import static com.openjdk.tools.packager.windows.WindowsBundlerParam.MENU_GROUP;
import static com.openjdk.tools.packager.windows.WindowsBundlerParam.INSTALLDIR_CHOOSER;
    ...
    public void testValidateVersion() {
        ...
        for(String v: validVersions) {
            assertTrue("Expect to be valid ["+v+"]",
                    com.openjdk.tools.packager.windows.WinMsiBundler.isVersionStringValid(v));
        }
