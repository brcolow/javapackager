...
public class LinuxAppBundler extends AbstractImageBundler {
    ...
    public static final BundlerParamInfo<RelativeFileSet> LINUX_RUNTIME = new StandardBundlerParam<>(
            "JRE",
            "The Java Runtime to co-bundle. The default value is the current JRE running the bundler. A value of null" +
                    " will cause no JRE to be co-bundled and the system JRE will be used to launch the application.",
    ...
    public String getDescription() {
        return "A Directory based image of a linux Application with an optionally co-bundled JRE. " +
                "Used as a base for the Installer bundlers.";
    }
