...
public class WindowsBundlerParam<T> extends StandardBundlerParam<T> {
    ...
    public WindowsBundlerParam(String name, String description, String id, Class<T> valueType,
    ...
    public static final BundlerParamInfo<RelativeFileSet> WIN_RUNTIME = new StandardBundlerParam<>(
            "System Wide",
            "Should this application attempt to install itself system wide, or only for each user?  Null means " +
